...
export namespace Prisma {
  ...
  */
  ...
  export type ListOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "createdAt" | "updateAt", ExtArgs["result"]["list"]>
  ...
  export interface Prisma__ListClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    item<T extends List$itemArgs<ExtArgs> = {}>(args?: Subset<T, List$itemArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ItemPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  export type ListUpdateOneRequiredWithoutItemNestedInput = {
    ...
    connect?: ListWhereUniqueInput
    update?: XOR<XOR<ListUpdateToOneWithWhereWithoutItemInput, ListUpdateWithoutItemInput>, ListUncheckedUpdateWithoutItemInput>
  }
